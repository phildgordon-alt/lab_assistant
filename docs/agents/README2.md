...
| `CLAUDE_ANALYTICS_VIZ.md` | Dashboards, visualization, handhelds, inter-dept comms, regression, R², demand sensing, consumption inventory, warehousing | Any dashboard UI, statistical modeling, Slack alert design, leaderboards, demand forecasting, inventory/WMS features |
...
| Assembly Dashboard | Architect + Manufacturing + Analytics/Viz |
| Department dashboard (any) | Architect + Analytics/Viz |
| Leaderboard / KPI tiles | Analytics/Viz |
| Handheld / mobile UI | Analytics/Viz |
| Slack alert design | Analytics/Viz |
| LensScanner / vision work | Architect + Vision |
| Kardex / ItemPath adapter | Architect + Automation + Data |
| EWS new trigger | Architect + Manufacturing + Analytics/Viz |
| Demand Sensing module | Analytics/Viz + Data + Manufacturing |
| Consumption-based inventory | Analytics/Viz + Data |
| WMS / warehouse features | Analytics/Viz + Data |
| Statistical model / regression | Analytics/Viz + Data |
| BLE tray tracking | Automation |
| Shift Report agent | Manufacturing + Analytics/Viz |
| Nightly ETL | Data |
